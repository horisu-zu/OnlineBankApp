...
fun PaymentInput(
    ...
    var pagerState = rememberPagerState(initialPage = initialCardIndex)
    ...
    Card(
        ...
        Column(
            ...
            Text(text = "Select Card", fontWeight = FontWeight.SemiBold, color = Color.DarkGray)
            Card(
                modifier = Modifier
                    .fillMaxWidth()
            ...
            InputField(
                ...
                onValueChange = { localDataInput = it },
                label = label,
                modifier = Modifier
